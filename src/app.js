// usualy <require from="bootstrap/css/bootstrap.css"></require> in the view is the way to go
// but theme demo change it dynamicly
// need jspm install css -f
import 'bootstrap';
  ...
  configureRouter(config, router) {
   config.title = 'Aurelia Demos';
    ...
    config.map([
      ...
      { route: 'flickr', name: 'flickr', moduleId: './flickr', nav: true, title: 'Flickr', icon: 'fa-camera-retro', done: 1, tags: ['http', 'jsonp', 'bind', 'repeat'], settings: { level: 1, show: true } },
      { route: 'githubusers', name: 'githubusers', moduleId: './githubusers', nav: true, title: 'GitHub User', icon: 'fa-users', done: 1, tags: ['http', 'fetch', 'bind', 'repeat'], settings: { level: 1, show: true } },
      ...
      { route: 'params/:all', name: 'params', moduleId: './paramsdemo', nav: true, title: 'Route Parameter', href: 'params', icon: 'fa-cog', done: 0, tags: ['query'], settings: { level: 1, show: true } },
