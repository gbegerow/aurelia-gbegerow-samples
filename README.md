# Aurelia Sample Collection

[![ZenHub](https://raw.githubusercontent.com/ZenHubIO/support/master/zenhub-badge.png)](https://zenhub.io)
[![Join the chat at https://gitter.im/aurelia/discuss](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/aurelia/discuss?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)

This is my private sample collection for the great [Aurelia](http://www.aurelia.io/) platform.
I use it mainly for demos and to remind myself about specific techniques. 
The code is currently JavaScript 2015 (ES6), transpiled with [Babel](https://babeljs.io/). 
My plans are to do finally a [Typescript](http://www.typescriptlang.org/) version, but don't hold your breath.

It is based on the standard [Skeleton Navigation App](https://github.com/aurelia/skeleton-navigation)
It sets up a standard navigation-style app using gulp to build your ES6 code with the Babel compiler. Karma/Protractor/Jasmine testing is also configured.

##*The Rest of the readme is a direct copy of the skeleton readme*
